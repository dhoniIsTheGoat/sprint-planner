export default function ReleaseProgressBar({ statusCounts, total, colorMap, completion }) {
  const entries = Object.entries(statusCounts).sort((a, b) => b[1] - a[1]);

  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
      <div style={{ flex: 1, height: 12, borderRadius: 6, background: '#e2e8f0', overflow: 'hidden', display: 'flex' }}>
